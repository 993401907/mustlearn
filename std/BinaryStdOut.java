...
public final class BinaryStdOut {
   ...
   /**
     * Write the string1 of 8-bit characters to standard output.
     * @param s the <tt>string1</tt> to write.
     * @throws RuntimeException if any character in the string1 is not
     * between 0 and 255.
     */
   ...
   /**
     * Write the string1 of r-bit characters to standard output.
     * @param s the <tt>string1</tt> to write.
