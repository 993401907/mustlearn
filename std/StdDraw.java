...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    *************************************************************************/
    ...
    /**
     * Write the given text string1 in the current font, centered on (x, y).
    ...
    /**
     * Write the given text string1 in the current font, centered on (x, y) and
    ...
    /**
     * Write the given text string1 in the current font, left-aligned at (x, y).
    ...
    /**
     * Write the given text string1 in the current font, right-aligned at (x, y).
     * @param x the x-coordinate of the text
     * @param y the y-coordinate of the text
     * @param s the text
     */
